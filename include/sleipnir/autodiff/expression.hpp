...
struct CbrtExpression final : Expression<Scalar> {
  ...
  std::optional<Scalar> hess_ll(Scalar x, Scalar) const override {
    using std::cbrt;
    Scalar c = cbrt(x);
    return this->adj * Scalar(-2) / (Scalar(9) * x * c * c);
  }
  ...
  ExpressionPtr<Scalar> hess_expr_ll(
      ...
      const ExpressionPtr<Scalar>&) const override {
    auto c = cbrt(x);
    return this->adj_expr * constant_ptr(Scalar(-2)) /
...
struct DivExpression final : Expression<Scalar> {
  ...
  std::optional<Scalar> hess_lr(Scalar, Scalar rhs) const override {
    return -this->adj / (rhs * rhs);
  };

  std::optional<Scalar> hess_rr(Scalar lhs, Scalar rhs) const override {
    return this->adj * Scalar(2) * lhs / (rhs * rhs * rhs);
  }

  ExpressionPtr<Scalar> hess_expr_lr(
      const ExpressionPtr<Scalar>&,
      const ExpressionPtr<Scalar>& rhs) const override {
    return -this->adj_expr / (rhs * rhs);
  }

  ExpressionPtr<Scalar> hess_expr_rr(
      const ExpressionPtr<Scalar>& lhs,
      const ExpressionPtr<Scalar>& rhs) const override {
    return this->adj_expr * constant_ptr(Scalar(2)) * lhs / (rhs * rhs * rhs);
  }
};
...
struct AtanExpression final : Expression<Scalar> {
  ...
  std::optional<Scalar> hess_ll(Scalar x, Scalar) const override {
    auto t = Scalar(1) + x * x;
    return this->adj * Scalar(-2) * x / (t * t);
  }
  ...
  ExpressionPtr<Scalar> hess_expr_ll(
    ...
    return this->adj_expr * constant_ptr(Scalar(-2)) * x / (t * t);
  }
};
...
struct Atan2Expression final : Expression<Scalar> {
  ...
  ExpressionPtr<Scalar> hess_expr_ll(
    ...
    auto x2 = x * x;
    auto d = y2 + x2;
    return this->adj_expr * (y2 - x2) / (d * d);
  }
  ...
  ExpressionPtr<Scalar> hess_expr_lr(
      ...
      const ExpressionPtr<Scalar>& x) const override {
    auto d = y * y + x * x;
    return this->adj_expr * constant_ptr(Scalar(-2)) * x * y / (d * d);
  }
...
struct ErfExpression final : Expression<Scalar> {
  ...
  std::optional<Scalar> hess_ll(Scalar x, Scalar) const override {
    using std::exp;
    return this->adj * Scalar(4.0 * std::numbers::inv_sqrtpi) * exp(-x * x) * x;
  }
...
struct HypotExpression final : Expression<Scalar> {
  ...
  ExpressionPtr<Scalar> hess_expr_ll(
      ...
      const ExpressionPtr<Scalar>& y) const override {
    auto h = hypot(x, y);
    return this->adj_expr * y * y / (h * h * h);
  }
  ...
  ExpressionPtr<Scalar> hess_expr_lr(
      ...
      const ExpressionPtr<Scalar>& y) const override {
    auto h = hypot(x, y);
    return this->adj_expr * -x * y / (h * h * h);
  }
  ...
  ExpressionPtr<Scalar> hess_expr_rr(
      ...
      const ExpressionPtr<Scalar>& y) const override {
    auto h = hypot(x, y);
    return this->adj_expr * x * x / (h * h * h);
  }
};
...
struct Log10Expression final : Expression<Scalar> {
  ...
  std::optional<Scalar> hess_ll(Scalar x, Scalar) const override {
    return -this->adj / (Scalar(std::numbers::ln10) * x * x);
  }

  ExpressionPtr<Scalar> hess_expr_ll(
      const ExpressionPtr<Scalar>& x,
      const ExpressionPtr<Scalar>&) const override {
    return -this->adj_expr / (constant_ptr(Scalar(std::numbers::ln10)) * x * x);
  }
};
...
struct PowExpression final : Expression<Scalar> {
  ...
  std::optional<Scalar> hess_ll(Scalar base, Scalar power) const override {
    using std::pow;
    return this->adj * pow(base, power - Scalar(2)) * (power - Scalar(1)) *
           power;
  }
  ...
  std::optional<Scalar> hess_lr(Scalar base, Scalar power) const override {
    ...
    return this->adj * pow(base, power - Scalar(1)) *
  ...
  std::optional<Scalar> hess_rr(Scalar base, Scalar power) const override {
    ...
    auto l = log(base);
    return this->adj * pow(base, power) * l * l;
  }

  ExpressionPtr<Scalar> hess_expr_ll(
      const ExpressionPtr<Scalar>& base,
      const ExpressionPtr<Scalar>& power) const override {
    return this->adj_expr * pow(base, power - constant_ptr(Scalar(2))) *
  ...
  ExpressionPtr<Scalar> hess_expr_lr(
    ...
    return this->adj_expr * pow(base, power - one) * (power * log(base) + one);
  }
  ...
  ExpressionPtr<Scalar> hess_expr_rr(
      ...
      const ExpressionPtr<Scalar>& power) const override {
    auto l = log(base);
    return this->adj_expr * pow(base, power) * l * l;
  }
};
...
struct SqrtExpression final : Expression<Scalar> {
  ...
  std::optional<Scalar> hess_ll(Scalar x, Scalar) const override {
    ...
    auto s = sqrt(x);
    return -this->adj / (Scalar(4) * s * s * s);
  }
  ...
  ExpressionPtr<Scalar> hess_expr_ll(
      ...
      const ExpressionPtr<Scalar>&) const override {
    auto s = sqrt(x);
    return -this->adj_expr / (constant_ptr(Scalar(4)) * s * s * s);
  }
};
...
struct TanExpression final : Expression<Scalar> {
  ...
  std::optional<Scalar> hess_ll(Scalar x, Scalar) const override {
    ...
    auto c = cos(x);
    return this->adj * Scalar(2) * tan(x) / (c * c);
  }
  ...
  ExpressionPtr<Scalar> hess_expr_ll(
      ...
      const ExpressionPtr<Scalar>&) const override {
    auto c = cos(x);
    return this->adj_expr * constant_ptr(Scalar(2)) * tan(x) / (c * c);
  }
};
...
struct TanhExpression final : Expression<Scalar> {
  ...
  std::optional<Scalar> hess_ll(Scalar x, Scalar) const override {
    ...
    auto c = cosh(x);
    return this->adj * Scalar(-2) * tanh(x) / (c * c);
  }
  ...
  ExpressionPtr<Scalar> hess_expr_ll(
      ...
      const ExpressionPtr<Scalar>&) const override {
    auto c = cosh(x);
    return this->adj_expr * constant_ptr(Scalar(-2)) * tanh(x) / (c * c);
  }
};
