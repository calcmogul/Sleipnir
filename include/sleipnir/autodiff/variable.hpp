...
class SLEIPNIR_DLLEXPORT Variable : public SleipnirBase {
 public:
   ...
   * @param value The value of the Variable.
   */
  Variable(SleipnirMatrixLike<Scalar> auto value)  // NOLINT
      : expr{value[0, 0].expr} {
  ...
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> operator*(const LHS& lhs,
                                                       const RHS& rhs) {
   ...
   * @return Result of multiplication.
   */
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> operator*(
      const Variable<Scalar>& lhs, const Variable<Scalar>& rhs) {
 ...
 private:
  ...
  // NOLINTNEXTLINE
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> abs(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> acos(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> asin(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> atan(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> atan2(  // NOLINT
      const ScalarLike auto& y, const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> atan2(  // NOLINT
      const Variable<Scalar>& y, const ScalarLike auto& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> atan2(  // NOLINT
      const Variable<Scalar>& y, const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> cbrt(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> cos(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> cosh(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> erf(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> exp(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> hypot(  // NOLINT
      const ScalarLike auto& x, const Variable<Scalar>& y);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> hypot(  // NOLINT
      const Variable<Scalar>& x, const ScalarLike auto& y);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> hypot(  // NOLINT
      const Variable<Scalar>& x, const Variable<Scalar>& y);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> log(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> log10(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> pow(  // NOLINT
      const ScalarLike auto& base, const Variable<Scalar>& power);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> pow(  // NOLINT
      const Variable<Scalar>& base, const ScalarLike auto& power);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> pow(  // NOLINT
      const Variable<Scalar>& base, const Variable<Scalar>& power);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> sign(const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> sin(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> sinh(const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> sqrt(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> tan(  // NOLINT
      const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> tanh(const Variable<Scalar>& x);
  template <typename Scalar>
  friend SLEIPNIR_DLLEXPORT Variable<Scalar> hypot(  // NOLINT
      const Variable<Scalar>& x, const Variable<Scalar>& y,
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> abs(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> acos(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> asin(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> atan(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> atan2(const ScalarLike auto& y,  // NOLINT
                                          const Variable<Scalar>& x) {
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> atan2(const Variable<Scalar>& y,  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> cbrt(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> cos(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> cosh(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> erf(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> exp(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> hypot(const ScalarLike auto& x,  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> hypot(const Variable<Scalar>& x,  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> pow(  // NOLINT
    const ScalarLike auto& base, const Variable<Scalar>& power) {
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> log(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> log10(  // NOLINT
    const Variable<Scalar>& x) {
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> sign(const Variable<Scalar>& x) {
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> sin(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> sinh(const Variable<Scalar>& x) {
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> sqrt(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> tan(const Variable<Scalar>& x) {  // NOLINT
 ...
 */
template <typename Scalar>
SLEIPNIR_DLLEXPORT Variable<Scalar> tanh(const Variable<Scalar>& x) {
...
struct SLEIPNIR_DLLEXPORT EqualityConstraints {
  ...
  template <typename LHS, typename RHS>
    requires SleipnirType<LHS> || SleipnirType<RHS>
  ...
  operator bool() {  // NOLINT
    return std::ranges::all_of(constraints, [](auto& constraint) {
      return constraint.value() == Scalar(0.0);
    });
  }
};
 ...
 */
template <typename LHS, SleipnirType RHS>
 ...
 * @param rhs Left-hand side.
 */
template <SleipnirType LHS, typename RHS>
auto operator==(LHS&& lhs, RHS&& rhs) {
 ...
 * @param rhs Left-hand side.
 */
template <SleipnirType LHS, SleipnirType RHS>
auto operator==(LHS&& lhs, RHS&& rhs) {
  return EqualityConstraints<typename std::decay_t<LHS>::Scalar>{lhs, rhs};
}
