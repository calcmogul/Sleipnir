...
sqp(const SQPMatrixCallbacks<Scalar>& matrix_callbacks,
  ...
  while (E_0 > Scalar(options.tolerance)) {
          ...
          scope_exit soc_exit{[&] {
            ...
            if (options.diagnostics) {
              print_iteration_diagnostics(
                  ...
                  trial_c_e.template lpNorm<1>(), Scalar(0.0), Scalar(0.0),
                  solver.hessian_regularization(), α_soc, Scalar(1.0),
                  α_reduction_factor, Scalar(1.0));
            }
          }};
    ...
    if (options.diagnostics) {
      print_iteration_diagnostics(iterations, IterationType::NORMAL,
                                  ...
                                  f, c_e.template lpNorm<1>(), Scalar(0.0),
                                  Scalar(0.0), solver.hessian_regularization(),
