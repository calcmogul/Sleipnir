...
/**
 * Matrix callbacks for the augmented Lagrangian solver.
 */
struct SLEIPNIR_DLLEXPORT AugmentedLagrangianMatrixCallbacks {
  ...
  std::function<Eigen::SparseMatrix<double>(
      ...
      const Eigen::VectorXd& z, double ρ, const Eigen::VectorXd& a)>
      H;
...
augmented_lagrangian(const AugmentedLagrangianMatrixCallbacks& matrix_callbacks,
