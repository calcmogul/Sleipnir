...
#ifndef SLEIPNIR_DISABLE_DIAGNOSTICS
/// Prints diagnostics for the interior-point method initial iterate.
///
/// @tparam Scalar Scalar type.
...
template <typename Scalar>
void print_ipm_initial_iterate_diagnostics(Scalar error, Scalar cost,
...
#else
#define print_ipm_initial_iterate_diagnostics(...)
#endif
...
template <typename Scalar>
void print_augmented_lagrangian_initial_iterate_diagnostics(
    Scalar error, Scalar cost, Scalar infeasibility, Scalar complementarity,
    Scalar ρ) {
  slp::println("┏{:━^119}┓", "");
  slp::println(
      "┃{:^4}   {:^9} {:^10} {:^11} {:^10} {:^8} {:^8} {:^5} {:^5} {:^8} {:^8} "
      "{:^8} {:^8} {:^2}┃",
      "iter", "duration", "error", "cost", "infeas.", "complem.", "ρ", "δ", "γ",
      "|p_pr|", "|p_du|", "α_pr", "α_du", "↩");
  slp::println("┡{:━^119}┩", "");

  slp::println(
      "│init   {:^9} {:10.4e} {:11.4e} {:10.4e} {:8.2e} {:8.2e} {:^50}│", "",
      error, cost, infeasibility, complementarity, ρ, "");
}
#else
#define print_augmented_lagrangian_initial_iterate_diagnostics(...)
#endif
...
void print_ipm_iteration_diagnostics(
    ...
    Scalar infeasibility, Scalar complementarity, Scalar μ, Scalar δ, Scalar γ,
    Scalar full_primal_step_inf_norm, Scalar full_dual_step_inf_norm,
...
void print_augmented_lagrangian_iteration_diagnostics(
  ...
  if (iterations % 20 == 0) {
    ...
    slp::println(
        "┃{:^4}   {:^9} {:^10} {:^11} {:^10} {:^8} {:^8} {:^5} {:^5} {:^8} "
        "{:^8} {:^8} {:^8} {:^2}┃",
        "iter", "duration", "error", "cost", "infeas.", "complem.", "ρ", "δ",
        "γ", "|p_pr|", "|p_du|", "α_pr", "α_du", "↩");
    slp::println("┡{:━^119}┩", "");
  }
  ...
  slp::println(
      ...
      "{:<5} {:8.2e} {:8.2e} {:8.2e} {:8.2e} {:2d}│",
      iterations, ITERATION_TYPES[std::to_underlying(type)], to_ms(time), error,
      cost, infeasibility, complementarity, ρ, power_of_10(δ), power_of_10(0),
      full_primal_step_inf_norm, full_dual_step_inf_norm, primal_α, dual_α,
      backtracks);
}
#else
