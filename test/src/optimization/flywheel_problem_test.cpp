...
TEMPLATE_TEST_CASE("Problem - Flywheel", "[Problem]", SCALAR_TYPES_UNDER_TEST) {
  ...
  // Inputs: [voltage]
  using std::exp;
  T A = exp(-dt.count());           // NOLINT
  T B = T(1.0) - exp(-dt.count());  // NOLINT
