...
TEMPLATE_TEST_CASE("Problem - Arm on elevator", "[Problem]",
  ...
  constexpr T ELEVATOR_START_HEIGHT{1.0};      // m
  constexpr T ELEVATOR_END_HEIGHT{1.25};       // m
  constexpr T ELEVATOR_MAX_VELOCITY{1.0};      // m/s
  constexpr T ELEVATOR_MAX_ACCELERATION{2.0};  // m/s²

  [[maybe_unused]]
  constexpr T ARM_LENGTH{1.0};                               // m
  constexpr T ARM_START_ANGLE{0.0};                          // rad
  ...
  constexpr std::chrono::duration<T> TOTAL_TIME{T(4.0)};
