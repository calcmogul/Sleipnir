...
void bind_iteration_info(em::class_<IterationInfo<double>>& cls) {
  ...
  cls.property("s", [](const IterationInfo<double>& self) { return self.s; });
  cls.property("y", [](const IterationInfo<double>& self) { return self.y; });
  cls.property("z", [](const IterationInfo<double>& self) { return self.z; });
