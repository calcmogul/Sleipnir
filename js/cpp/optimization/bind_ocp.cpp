...
void bind_ocp(em::class_<OCP<double>, Problem<double>>& cls) {
  ...
  cls.function(
      em::init<int, int, std::chrono::duration<double>, int,
  ...
  cls.function("constrain_initial_state",
               ...
               "initial_state"_a);
  cls.function("constrain_initial_state",
               &OCP<double>::constrain_initial_state<int>, "initial_state"_a);
  cls.function("constrain_initial_state",
  ...
  cls.function("constrain_final_state",
               &OCP<double>::constrain_final_state<double>, "final_state"_a);
  cls.function("constrain_final_state",
               &OCP<double>::constrain_final_state<int>, "final_state"_a);
  cls.function("constrain_final_state",
  ...
  cls.function("set_lower_input_bound",
               &OCP<double>::set_lower_input_bound<double>, "lower_bound"_a);
  cls.function("set_lower_input_bound",
               &OCP<double>::set_lower_input_bound<int>, "lower_bound"_a);
  cls.function("set_lower_input_bound",
  ...
  cls.function("set_upper_input_bound",
               &OCP<double>::set_upper_input_bound<double>, "upper_bound"_a);
  cls.function("set_upper_input_bound",
               &OCP<double>::set_upper_input_bound<int>, "upper_bound"_a);
  cls.function("set_upper_input_bound",
