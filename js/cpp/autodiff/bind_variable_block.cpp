...
void bind_variable_block(
  ...
  cls.function("set_value", [](VariableBlock<VariableMatrix<double>>& self,
                               double value) { self.set_value(value); });
  cls.function("set_value", [](VariableBlock<VariableMatrix<double>>& self,
  ...
  cls.function("__setitem__", [](VariableBlock<VariableMatrix<double>>& self,
                                 int row, const Variable<double>& value) {
    if (row < 0) {
      row += self.size();
    }
  ...
  cls.function("__setitem__", [](VariableBlock<VariableMatrix<double>>& self,
                                 em::tuple slices, em::object value) {
    if (slices.size() != 2) {
  ...
  cls.function(
      ...
      em::keep_alive<0, 1>());
  cls.function("row", em::overload_cast<int>(
                          &VariableBlock<VariableMatrix<double>>::row));
  cls.function("col", em::overload_cast<int>(
                          &VariableBlock<VariableMatrix<double>>::col));
  ...
  cls.function("value", em::overload_cast<int, int>(
                            &VariableBlock<VariableMatrix<double>>::value));
  cls.function("value", em::overload_cast<int>(
                            &VariableBlock<VariableMatrix<double>>::value));
